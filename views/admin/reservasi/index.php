            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Cari reservasi user,kamar" id="searchInput">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            if (isset($_GET['search']) && !empty($_GET['search'])) {
                                $stmt = $reservasi->search($_GET['search']);
                            } else {
                            ...
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                // Tambahkan logika ini agar status reservasi ikut menyesuaikan
                                if ($row['status'] == 'menunggu' && $row['pembayaran']) {
                            ...
                            <?php if (empty($reservasiList)): ?>
                                <tr><td colspan="8" class="text-center">Reservasi tidak ditemukan.</td></tr>
                            <?php else: ?>
                                <?php foreach ($reservasiList as $row): ?>
                                    <?php if ($row['status'] === 'selesai') continue; // hide selesai ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#detailModal<?php echo $row['id']; ?>">
                                                            <i class="fas fa-eye me-1"></i> Detail
                                                        </a>
                                                    </li>

                                                    <!-- Batalkan jika MENUNGGU -->
                                                    <?php if ($row['status'] == 'menunggu'): ?>
                                                        <li>
                                                            <a class="dropdown-item" href="http://localhost/hotel_reservation/proses/reservasi/update_status.php?id=<?php echo $row['id']; ?>&status=dibatalkan">
                                                                <i class="fas fa-times me-1"></i> Batalkan
                                                            </a>
                                                        </li>
                                                    <?php endif; ?>

                                                    <!-- Batalkan juga jika DIKONFIRMASI -->
                                                    ...
                                                    <?php if ($row['status'] == 'dikonfirmasi' || $row['status'] == 'dibatalkan'): ?>
                                                        <li>
                                                            <a class="dropdown-item" href="http://localhost/hotel_reservation/proses/reservasi/update_status.php?id=<?php echo $row['id']; ?>&status=selesai">
